...
description: >
  ...
  efficient, and maintainable Python applications. Use when writing new Python code, reviewing
  Python code, refactoring existing Python, designing Python packages or modules, or when the
  user asks about Python conventions, code style, typing, error handling patterns, or
