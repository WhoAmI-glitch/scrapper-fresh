...
name: alpha-vantage
description: >
  Access real-time and historical stock market data, forex rates, cryptocurrency prices,
  commodities, economic indicators, and 50+ technical indicators via the Alpha Vantage API.
  Use when fetching stock prices (OHLCV), company fundamentals (income statement, balance sheet,
  cash flow), earnings data, technical indicators (RSI, MACD, Bollinger Bands), forex exchange
  rates, crypto prices, or economic data (GDP, CPI, unemployment). Also use when the user
  mentions Alpha Vantage, stock data, market data, financial API, or needs programmatic access
  to financial market information.
---
...
Use this skill when fetching financial market data, stock prices, forex rates, crypto prices, economic indicators, or technical analysis indicators via the Alpha Vantage API.
