...
description: >
  ...
  Based on Supabase best practices. Use when writing SQL queries or migrations, designing
  database schemas, troubleshooting slow queries, implementing Row Level Security, setting up
  PostgreSQL indexes, or when the user mentions Postgres, SQL performance, database design,
  RLS policies, or Supabase database configuration.
---
