...
description: >
  Automatically extract reusable patterns from Claude Code sessions and save them as learned
  skills for future use. Use when the user wants to capture workflows, remember debugging
  techniques, extract session patterns, set up learning hooks, or build a persistent skill
  library from past conversations. Also activate when discussing session analysis, pattern
  extraction, or continuous improvement of Claude's behavior across sessions.
---
