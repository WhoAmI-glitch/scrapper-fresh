...
description: >
  ...
  Use when making decisions, evaluating options, weighing trade-offs, choosing between
  alternatives, analyzing pros and cons, prioritizing features or tasks, comparing tools
  or technologies, or when the user says things like "should I use X or Y", "help me decide",
  "what are the trade-offs", or needs a decision matrix, RICE scoring, or weighted evaluation.
license: MIT
metadata:
